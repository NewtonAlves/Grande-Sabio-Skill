...
Use este arquivo para cenas, capítulos, enredos, arcos, ritmo e diagnóstico estrutural.

## Unidade Básica De Cena

Toda cena deve ter, salvo escolha consciente:

- Objetivo: o que alguém quer agora.
- Obstáculo: o que impede.
- Pressão: por que importa neste momento.
- Ação: o que o personagem tenta.
- Mudança: o que fica diferente no fim.

## Diagnóstico Rápido

- Cena sem conflito: inserir obstáculo entre desejo e resultado.
- Cena sem mudança: terminar com decisão, perda, descoberta, inversão ou custo.
- Capítulo sem função: definir o que ele revela, complica ou resolve.
- Enredo episódico: criar causalidade entre eventos.
- Ritmo lento: cortar repetição, exposição e transições sem tensão.
- Ritmo acelerado demais: dar espaço a consequência emocional e escolha.

## Revisão Estrutural

1. Mapear promessas abertas.
2. Identificar viradas principais.
3. Checar causalidade.
4. Checar arco de personagem.
